  ...
  return (
    <div className="tj ph7 pv4 v-top">
      ...
      <p>
        ...
        processing, such as authentication and storage information. All provided
        Personal data could be used for analyzing and improving the work of the
        Service. By using the "Simple-Market" application, You agree to the
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> meansthe software program provided by
            Owner downloaded by You on any electronic device.
          </p>
        </li>
        <li>
          <p>
            <strong>Owner</strong> (referred to as either &quot;the Owner&quot;,
            &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement)
            refers to Andrii Melnyk.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        Protocol address (e.g. IP address), the pages of our Service that You
      ...
      <p>
        Simple Market" doesn't use your personal information as it's a demo
        version, however, there is a posibility that Your data could be used for
        Analytics purpose or by third parties according to their purpose. There
        for we do not recommend to store any sensatife information. The
        information is stored on the Service Provider's server and on Your
        device.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>For analytical and development purposes. </strong>
          </p>
        </li>
        <li>
          <p>
      ...
      <h2>Termination of the Service</h2>
      <p>
        If you would like to delete all your personal information including
        email (terminate your account) You need contact us.
      </p>
      <h2>Contact Us</h2>
      <p>
      ...
      <ul>
        <li>By email: andriimelnyk.native@gmail.com</li>
      </ul>
    </div>
  );
}
